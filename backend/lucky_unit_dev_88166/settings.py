"""
Django settings for lucky_unit_dev_88166 project.
...
ROOT_URLCONF = 'lucky_unit_dev_88166.urls'
...
WSGI_APPLICATION = 'lucky_unit_dev_88166.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lucky_unit_dev_88166 API",
    "DESCRIPTION": "API documentation for lucky_unit_dev_88166 App",
    "VERSION": "v1",
}
